...
This Docker Compose configuration provides a complete local development environment for the Geo-Intelligence Platform. It includes all core services with production-equivalent configurations.
...
```bash
# Clone repository
git clone https://github.com/your-org/geo-intelligence-platform
