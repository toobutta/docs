...
This document outlines the **complete development plan** for the Geo-Intelligence Platform MVP, covering methodology, architecture, implementation phases, and success criteria for a **90-day delivery**.
...
servers:
  - url: https://api.geointel.example.com/v1
    description: Production
  - url: https://staging-api.geointel.example.com/v1
    description: Staging
...
components:
  securitySchemes:
    OAuth2:
      ...
      flows:
        clientCredentials:
          tokenUrl: https://auth.geointel.example.com/oauth/token
          scopes:
