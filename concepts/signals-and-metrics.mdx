...
The Geo-Intelligence Platform generates **signals** (time-series metrics) from computer vision, satellite imagery, and geospatial data. Every signal includes standardized metadata: **unit**, **cadence**, **method**, **quality_score**, and **provenance**.
