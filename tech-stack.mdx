...
description: "Cost-optimized, performant open-source technology stack for the Geo-Intelligence Platform"
---

## Overview

This document defines the **production technology stack** for the Geo-Intelligence Platform MVP, optimized for:
